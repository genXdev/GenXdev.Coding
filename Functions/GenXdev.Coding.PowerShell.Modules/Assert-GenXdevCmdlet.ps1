    ...
    begin {
        try {
            ...
            if ($Integrate) {
                ...
                $destination = GenXdev.FileSystem\Expand-Path "$PSScriptRoot\..\..\..\..\..\Modules\$baseDestinationModule\1.234.2025\Functions\$ModuleName\$CmdletName.ps1" -CreateDirectory
                ...
                GenXdev.Coding\SplitUpPsm1File -Path "$PSScriptRoot\..\..\..\..\..\Modules\$baseDestinationModule\1.234.2025\$ModuleName.psm1"
