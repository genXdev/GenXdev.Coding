        ...
        if ($PSCmdlet.ShouldProcess($target, $action)) {
            ...
            if (-not [string]::IsNullOrWhiteSpace($BaseModuleName)) {
                ...
                $filePath = GenXdev.FileSystem\Expand-Path `
                    "$PSScriptRoot\..\..\..\..\$BaseModuleName\2.3.2026\Functions\$ModuleName\$CmdletName.ps1" `
                    -DeleteExistingFile -CreateDirectory

                $testFilePath = GenXdev.FileSystem\Expand-Path `
                    "$PSScriptRoot\..\..\..\..\$BaseModuleName\2.3.2026\Tests\$ModuleName\$CmdletName.Tests.ps1" `
                    -DeleteExistingFile -CreateDirectory
...
"@ | Microsoft.PowerShell.Utility\Out-File  $filePath
                ...
                $ModuleManifestPath = GenXdev.FileSystem\Expand-Path "$PSScriptRoot\..\..\..\..\$BaseModuleName\2.3.2026\$BaseModuleName.psd1"
                ...
                $ModuleManifest.FileList += (GenXdev.FileSystem\Find-Item $filePath -RelativeBasePath (GenXdev.FileSystem\Expand-Path "$PSScriptRoot\..\..\..\..\$BaseModuleName\2.3.2026\")).Substring(2)
                $ModuleManifest.FileList += (GenXdev.FileSystem\Find-Item $testFilePath -RelativeBasePath (GenXdev.FileSystem\Expand-Path "$PSScriptRoot\..\..\..\..\$BaseModuleName\2.3.2026\")).Substring(2)
                ...
                $PsmFilePath = GenXdev.FileSystem\Expand-Path "$PSScriptRoot\..\..\..\..\$BaseModuleName\2.3.2026\$ModuleName.psm1"
