    ...
    process {
        ...
        Microsoft.PowerShell.Core\ForEach-Object {
            ...
            try {
                ...
                Microsoft.PowerShell.Management\Get-ChildItem .\*.*.* -dir | Microsoft.PowerShell.Core\Where-Object { $_.Name -ne '1.174.2025' } |
                Microsoft.PowerShell.Core\ForEach-Object {
                ...
                Microsoft.PowerShell.Utility\Write-Verbose "Processing version directory 1.174.2025"
                Microsoft.PowerShell.Management\Set-Location .\1.174.2025
