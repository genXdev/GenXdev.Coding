        ...
        Microsoft.PowerShell.Management\Get-ChildItem -LiteralPath "$PSScriptRoot\..\..\..\..\..\Modules" -Filter  "genxdev*" -dir |
            Microsoft.PowerShell.Core\ForEach-Object {
                ...
                try {
                    ...
                    Microsoft.PowerShell.Management\Get-ChildItem -LiteralPath .\ -Filter "*.*.*" -dir | Microsoft.PowerShell.Core\Where-Object { $_.Name -ne '1.238.2025' } |
                        Microsoft.PowerShell.Core\ForEach-Object {
                        ...
                        Microsoft.PowerShell.Utility\Write-Verbose 'Processing version directory 1.238.2025'
                        Microsoft.PowerShell.Management\Set-Location -LiteralPath .\1.238.2025
