        ...
        Microsoft.PowerShell.Management\Get-ChildItem "$PSScriptRoot\..\..\..\..\..\Modules\genxdev*" -dir |
            Microsoft.PowerShell.Core\ForEach-Object {
                ...
                try {
                    ...
                    Microsoft.PowerShell.Management\Get-ChildItem .\*.*.* -dir | Microsoft.PowerShell.Core\Where-Object { $_.Name -ne '1.220.2025' } |
                        Microsoft.PowerShell.Core\ForEach-Object {
                        ...
                        Microsoft.PowerShell.Utility\Write-Verbose 'Processing version directory 1.220.2025'
                        Microsoft.PowerShell.Management\Set-Location .\1.220.2025
