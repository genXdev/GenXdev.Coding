...
function New-PullRequestForGenXdevModuleChanges {
    ...
    process {
        ...
        $modulePath = GenXdev.FileSystem\Expand-Path (
            "$PSScriptRoot\..\..\..\..\$ModuleName\3.23.2026\"
        )
        ...
        # --- Begin Modification ---
        # Find the commit with the exact message "Release 3.23.2026" in the GenXdev module repository using the GitHub API
        $releaseCommitMsg = 'Release 3.23.2026'
