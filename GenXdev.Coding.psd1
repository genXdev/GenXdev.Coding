...
@{
    ...
    RequiredModules       = @(@{ModuleName = 'PSScriptAnalyzer'; ModuleVersion = '1.23.0'; },
        @{ModuleName = 'GenXdev.AI'; ModuleVersion = '1.124.2025'; },
        @{ModuleName = 'GenXdev.Data'; ModuleVersion = '1.124.2025'; },
    ...
    'Get-GenXDevModules', 'Get-GenXDevNewModulesByDependencies',
    ...
    'Show-RefactorReport', 'Start-NextRefactor', 'Add-ReleaseNoteLineToREADME',
    'ReleaseNotes',
