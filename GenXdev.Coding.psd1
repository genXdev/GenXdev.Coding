...
RequiredModules = @(@{ModuleName = 'PSScriptAnalyzer'; ModuleVersion = '1.23.0'; },
               @{ModuleName = 'GenXdev.AI'; ModuleVersion = '1.118.2025'; },
...
FunctionsToExport = 'Add-FeatureLineToREADME', 'Add-IdeaLineToREADME',
               ...
               'New-GitCommit', 'New-Refactor', 'Open-SourceFileInIde',
               'PermanentlyDeleteGitFolders', 'Remove-Refactor',
               'Search-GenXdevCmdlet', 'Search-NextGenXdevCmdlet',
...
FileList = 'GenXdev.Coding.FileSystem.psm1', 'GenXdev.Coding.Git.psm1',
               ...
               'Tests\GenXdev.Coding.PowerShell.Modules\Open-SourceFileInIde.Tests.ps1',
               ...
               'Functions\GenXdev.Coding.PowerShell.Modules\Open-SourceFileInIde.ps1',
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = 'Git','Shell','GenXdev','Coding','VSCode','Visual Studio Code','Visual Studio','Refactoring','Code','Code Quality','Code Review','Code Analysis','Code Metrics','Github CoPilot','Github'
