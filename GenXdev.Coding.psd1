...
RequiredModules = @(@{ModuleName = 'PSScriptAnalyzer'; ModuleVersion = '1.23.0'; },
               @{ModuleName = 'GenXdev.AI'; ModuleVersion = '1.134.2025'; },
               @{ModuleName = 'GenXdev.Data'; ModuleVersion = '1.134.2025'; },
               @{ModuleName = 'GenXdev.Helpers'; ModuleVersion = '1.134.2025'; },
               @{ModuleName = 'GenXdev.Windows'; ModuleVersion = '1.134.2025'; },
               @{ModuleName = 'GenXdev.Webbrowser'; ModuleVersion = '1.134.2025'; },
               @{ModuleName = 'GenXdev.Queries'; ModuleVersion = '1.134.2025'; },
               @{ModuleName = 'GenXdev.Console'; ModuleVersion = '1.134.2025'; },
               @{ModuleName = 'GenXdev.FileSystem'; ModuleVersion = '1.134.2025'; })
...
FunctionsToExport = 'Add-FeatureLineToREADME', 'Add-IdeaLineToREADME',
               ...
               'Assert-GenXdevCmdletTests', 'Assert-GenXdevUnitTests',
               'Assert-ModuleDefinition', 'Assert-NextGenXdevCmdlet',
               'Assert-NextGenXdevCmdletTest', 'Assert-RefactorFile',
               'AssureCopilotKeyboardShortCut', 'AssureVSCodeInstallation',
               'Complete-GenXDevREADME', 'Features', 'Get-GenXDevModule',
               'Get-GenXDevModuleInfo', 'Get-GenXDevNewModulesInOrderOfDependency',
               'Get-GenXDevNextCmdLet', 'Get-ModuleHelpMarkdown', 'Get-Refactor',
               'Get-RefactorReport', 'Ideas', 'Invoke-GenXdevScriptAnalyzer', 'Issues',
               ...
               'Update-Refactor', 'VSCode', '_AssertGenXdevUnitTests'
...
AliasesToExport = 'commit', 'editcmdlet', 'editcode', 'feature', 'gcmd',
               ...
               'issue', 'newrefactor', 'nextcmdlet', 'nextcmdlettest', 'nextrefactor',
               'refactor', 'refactorreport', 'refactors', 'ReleaseNote', 'searchcmdlet',
               'todo', 'rungenxdevtests'
...
FileList = 'GenXdev.Coding.Git.psm1', 'GenXdev.Coding.PowerShell.Modules.psm1',
               ...
               'Tests\GenXdev.Coding.PowerShell.Modules\Assert-GenXdevUnitTests.Tests.ps1',
               ...
               'Prompts\GenXdev.Coding.PowerShell.Modules\Assert-DocumentationOnly.txt',
               ...
               'Functions\GenXdev.Coding.PowerShell.Modules\Assert-GenXdevUnitTests.ps1',
