...
RequiredModules = @(@{ModuleName = 'GenXdev.AI'; ModuleVersion = '1.302.2025'; })
...
FunctionsToExport = 'Add-LineToREADME', 'Add-MissingGenXdevUnitTests', 
               'Assert-GenXdevCmdlet', 'Assert-GenXdevDependencyUsage', 
               'Assert-GenXdevTest', 'Assert-ModuleDefinition', 
               'Assert-RefactorFile', 'Complete-GenXDevREADME', 
               'EnsureCopilotKeyboardShortCut', 'EnsureDefaultGenXdevRefactors', 
               'EnsureVSCodeInstallation', 'Get-GenXdevCmdletUsageAnalysis', 
               'Get-GenXDevModuleInfo', 'Get-ModuleHelpMarkdown', 'Get-Refactor', 
               'Ideas', 'Invoke-GenXdevPSFormatter', 'Invoke-GenXdevScriptAnalyzer', 
               'Issues', 'New-GenXdevCmdlet', 'New-GenXdevModule', 
               'New-PullRequestForGenXdevModuleChanges', 'New-Refactor', 
               'Open-SourceFileInIde', 'PermanentlyDeleteGitFolders', 'ReleaseNotes', 
               'Show-GenXdevCmdLetInIde', 'SplitUpPsm1File', 'Start-NextRefactor', 
...
CmdletsToExport = 'Add-FeatureLineToREADME', 'Add-IdeaLineToREADME', 
               ...
               'Clear-GenXdevModules', 'Complete-GenXdevHelpFile', 'Get-Features', 
               'Get-GenXDevModule', 'Get-GenXDevNewModulesInOrderOfDependency', 
               'Get-GitChangedFiles', 'Get-RefactorReport', 'New-GitCommit', 
...
FileList = '.gitignore', 'GenXdev.Coding-Help.xml', 'GenXdev.Coding.csproj', 
               ...
               'Functions\GenXdev.Coding.PowerShell.Modules\Complete-GenXdevHelpFile.cs', 
               ...
               'Assets\Modules\GenXdev.Local\1.302.2025\GenXdev.Local.psd1.asset.txt', 
               'Assets\Modules\GenXdev.Local\1.302.2025\GenXdev.Local.psm1.asset.txt', 
               'Assets\Modules\GenXdev.Local\1.302.2025\powershell.jpg.asset.txt', 
               'Assets\Modules\GenXdev.Local\1.302.2025\README.md.asset.txt', 
